...
class Client {
     ...
     * @return Success
     */
    authSessionCurrent(cancelToken) {
    ...
    processAuthSessionCurrent(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    processAuthSessionRevoke(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    processAuthSessionRefresh(response) {
        ...
        if (status === 200) {
            ...
            let resultData401 = _responseText;
            result401 = JSON.parse(resultData401);
            return throwException("Invalid refresh token", status, _responseText, _headers, result401);
        }
        else if (status === 403) {
            const _responseText = response.data;
            let result403 = null;
            let resultData403 = _responseText;
            result403 = JSON.parse(resultData403);
            return throwException("Refreshing with another ip is not allowed (sameIp is enabled for this session)", status, _responseText, _headers, result403);
        }
        else if (status === 404) {
            const _responseText = response.data;
            let result404 = null;
    ...
    processServerPublicKey(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    processServerInviteCodes(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    serverInviteCodesCreate(body, cancelToken) {
        let url_ = this.baseUrl + "/server/invitecodes";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
    ...
    processServerInviteCodesCreate(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 204) {
            ...
            let resultData409 = _responseText;
            result409 = JSON.parse(resultData409);
            return throwException("Invite code already exists", status, _responseText, _headers, result409);
        }
        else if (status === 429) {
            const _responseText = response.data;
            let result429 = null;
     ...
     * @return Success
     */
    serverInviteCodesGenerate(body, cancelToken) {
    ...
    processServerInviteCodesGenerate(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    serverInviteCodesInfo(code, cancelToken) {
    ...
    processServerInviteCodesInfo(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let resultData404 = _responseText;
            result404 = JSON.parse(resultData404);
            return throwException("Invite code not found", status, _responseText, _headers, result404);
        }
        else if (status === 429) {
            const _responseText = response.data;
            let result429 = null;
     ...
     * @return Success
     */
    serverInviteCodesDelete(code, cancelToken) {
        let url_ = this.baseUrl + "/server/invitecodes/{code}";
        if (code === undefined || code === null)
            throw new Error("The parameter 'code' must be defined.");
        url_ = url_.replace("{code}", encodeURIComponent("" + code));
    ...
    processServerInviteCodesDelete(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    gamesGuess(id, cancelToken) {
        let url_ = this.baseUrl + "/games/guess/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.instance
            ...
            .then((_response) => {
            return this.processGamesGuess(_response);
        });
    }
    processGamesGuess(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
...
function isLoginSuccess(object) {
